...
export const CONSTANTS = {
  ...
  PM_TALK_LIST: env.PM_TALK_LIST || 'PLMzVnzbHaB8uIwll5pY7z7W7RI88h7nIv',
  COURSE_PREVIEW: env.COURSE_PREVIEW || 'PLMzVnzbHaB8uqc3APlK_oXkDaOhmMmrrY',
  KARMAYOGI_TALKS: env.KARMAYOGI_TALKS || 'PLMzVnzbHaB8tpuYUiTTITmSgMfH8uZWMN',
}
